...
if (!process.env.OPENROUTER_API_KEY) {
    console.error("FATAL ERROR: OPENROUTER_API_KEY is missing in .env file!");
    console.error("The AI Coach WILL NOT WORK without this key.");
} else {
    console.log("✅ System Check: API Key is present.");
}
...
app.get('/api/health', (req, res) => {
    res.json({ status: 'active', timestamp: new Date(), brain: process.env.OPENROUTER_API_KEY ? 'connected' : 'disconnected' });
});
